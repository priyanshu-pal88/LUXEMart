    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="max-w-md w-full fade-in">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-400 text-lg">Sign in to your exclusive account</p>
        </div>
        ...
        <div className="glass-card rounded-3xl p-10">
          <form onSubmit={handleSubmit(submitHandler)} className="space-y-7">
            ...
            <button
              type="submit"
              className="w-full luxury-btn py-4 px-4 rounded-xl font-semibold text-white flex items-center justify-center gap-2 text-lg"
            >
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-400">
              ...
              <Link to="/register" className="rose-gold-text hover:text-pink-400 font-semibold transition">
                Join LUXEMart
              </Link>
            </p>
          </div>
